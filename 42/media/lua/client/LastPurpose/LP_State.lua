...
function LastPurpose.getData(p)
 ...
 if type(root[LastPurpose.SAVE_KEY])~="table" then root[LastPurpose.SAVE_KEY]={schema=4,active=false,completed=false,stage=0,trackerVisible=true,objectives={}} end
 local d=root[LastPurpose.SAVE_KEY]; d.schema=4
